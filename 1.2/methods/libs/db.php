 ...
 * @since 0.71
 * 
 * Modified as Standalone for Caldera Engine standalone export.
 * 
 * Changes: 
 * - Removed Set Prefix
 * - Added is_multisite() to return always false
 * - Removed $query = apply_filters( 'query', $query ); from query()
 * - 
 * 
 */
...
// Addedd is_multisite to return a false for prefixing
 ...
 *
 * @link http://codex.wordpress.org/Function_Reference/db_Class
 *
 * @package WordPress
 * @subpackage Database
 * @since 0.71
...
class db {
	 ...
	 * @uses db::$tables
	 * @uses db::$old_tables
	 * @uses db::$global_tables
	 * @uses db::$ms_global_tables
	 * @uses is_multisite()
	 *
	 * @param string $scope Optional. Can be all, global, ms_global, blog, or old tables. Defaults to all.
	 * @param bool $prefix Optional. Whether to include table prefixes. Default true. If blog
	 * 	prefix is requested, then the custom users and usermeta tables will be mapped.
	 * @param int $blog_id Optional. The blog_id to prefix. Defaults to db::$blogid. Used only when prefix is requested.
...
" ), htmlspecialchars( $this->dbhost, ENT_QUOTES ) ), 'db_connect_fail' );
	 ...
	 * 	A format is one of '%d', '%f', '%s' (integer, float, string). If omitted, all values in $data will be treated as strings unless otherwise specified in db::$field_types.
...
//BETA SETTINGS
//$db = new db('humblwty_humble', 'humble42!', 'humblwty_dev', 'humble.co.za');
$db = new db('humble', 'humble12!', 'humble_dev', 'localhost');
//$db = new db('root', 'root', 'humbletill', 'localhost');
